...
##Base Case (Standard Play)- If no one has blackjack, Player1 gets to evaluate hand (and decide on
##strategy based on Dealer's upcard) and decide whether to HIT or STAND.  
def standardplay(games_max,ind):

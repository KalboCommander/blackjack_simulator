...
##Strategy - Player will always double down on hard 11 (i.e. draw only one more card as his final draw, irregardless of results)
def DD_Hard_Eleven(games_max,ind):
    ...
    while gc < games_max:
        ...
        ##Strategy Implementation (lines 50-63)
        else:    
            DD = 0
            if player1.hand[0].value + player1.hand[1].value == 11:
    ...
    print('\n*** "Double Down on Hard 11" Strategy ***')
